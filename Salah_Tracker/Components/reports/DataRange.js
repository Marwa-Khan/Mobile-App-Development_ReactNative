...
export default function DataRange() {
          ...
          //       strokeDasharray: "0",
            ...
            const data = {
                ...
                datasets:[{
                          data:[Report.filter(k=>k.Fajar==="Offered").length,
                          Report.filter(k=>k.Dhuhr==="Offered").length,
                          Report.filter(k=>k.Asr ==="Offered").length,
                          Report.filter(k=>k.Maghrib==="Offered").length,
                          Report.filter(k=>k.Isha==="Offered").length,]
                }]
